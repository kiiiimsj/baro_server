...
<html>
    ...
    <body>
        ...
        InstructorTitleBean stb = sd.makeInstructorDeptNameSalaryTitle(sql, 1);
        out.print("<tr><td>"+stb.getDeptNameTitle()+"</td>");
        out.print("<td>"+stb.getSalaryTitle()+"</td></tr>");
        
        list = sd.makeListAllInstructorDeptNameSalary(sql, 1);
