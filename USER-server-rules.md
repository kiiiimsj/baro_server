...
- [회원관련](#회원관련) 
    ...
    - [이메일 변경 처리](#회원-이메일-변경-처리)
- [알림관련](#알림-관련-api)
    - [안읽은 알림 갯수 가져오기](#회원이-로그인했을때-안읽은-알림의-갯수-가져오기)
    - [클릭한 알림 읽음처리로 바꾸기](#클릭한-알림-읽음처리로-바꾸기)
- [이벤트관련](#이벤트-api)
  - [광고배너 이벤트에 대한 정보 가져오기](#광고배너-이벤트에-대한-정보-가져오기)
  - [광고배너 세부정보 가져오기](#광고배너-이벤트중-하나를-클릭했을때-세부정보-가져오기)
- [가게종류관련](#가게-종류-관련-api)
  - [가게 종류 목록 가져오기](#가게-종류-목록-가져오기)
- [ultra/new 가게관련]()
