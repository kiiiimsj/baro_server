...
<html>
    ...
    <body>
        ...
        String sql="select name, course_id from instructor, teaches where (instructor.ID, dept_name)=(teaches.ID, 'Biology')";
        
        InstructorDao sd = new InstructorDao();
        InstructorBean sb = null;
        
        InstructorTitleBean stb = sd.makeInstructorTitleWithTeachesCourseId(sql);
        TeachesTitleBean ttb = stb.getTtb();
        out.print("<tr><td>"+stb.getNameTitle()+"</td>");
        out.print("<td>"+ttb.getCourseIdTitle()+"</td></tr>");
        
        list = sd.makeListAllInstructorWithTeachesCourseId(sql);
        ...
        while(it.hasNext()){
            ...
            out.print("<td> "+ tb.getCourseId() +"</td></tr>");
            out.print("\n");
        }
        out.println();
        %>
