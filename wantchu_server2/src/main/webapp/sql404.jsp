...
<html>
    ...
    <body>
        ...
        String sql="select ID, name, salary/12 from instructor";
        
        InstructorDao sd = new InstructorDao();
        InstructorBean sb = null;
        
        InstructorTitleBean stb = sd.makeInstructorIdNameSalaryTitle(sql);
        out.print("<tr><td>"+stb.getIdTitle()+"</td>");
        out.print("<td>"+stb.getNameTitle()+"</td>");
        out.print("<td>"+stb.getSalaryTitle()+"</td></tr>");
        
        list = sd.makeListAllInstructorIdNameSalary(sql);
